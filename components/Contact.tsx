    ...
    <section id="contact" className="py-32 border-t border-white/5">
      <div className="max-w-4xl mx-auto px-6">
        <div className="text-center mb-16 space-y-3">
          ...
          <h2 className="text-4xl md:text-5xl font-thin text-[#ffffff]">Contact</h2>
          ...
          {status === "success" ? (
            <div className="flex items-center justify-center text-center md:col-span-2 py-16">
              <div className="space-y-3">
                ...
                <p className="text-[#ffffff] font-thin text-xl">Message Sent</p>
                <p className="text-[#e0e0e0]/50 text-sm">I&apos;ll get back to you soon.</p>
              </div>
            </div>
          ) : (
            <form onSubmit={handleSubmit} className="space-y-5">
              {[
                ...
                <div key={f.id} className="relative">
                  <input
                    ...
                    className="peer w-full bg-transparent border-b border-white/10 focus:border-[#c8a97e] text-[#ffffff] text-sm py-3 outline-none transition-colors placeholder-transparent"
                    placeholder={f.label}
                  />
                  <label
                    htmlFor={f.id}
                    className="absolute left-0 -top-3 text-[10px] tracking-widest uppercase text-[#c8a97e]/60 peer-placeholder-shown:text-xs peer-placeholder-shown:top-3 peer-placeholder-shown:text-[#e0e0e0]/40 transition-all duration-200"
                  >
                    {f.label}
                  </label>
                </div>
              ...
              <div className="relative">
                <textarea
                  ...
                  className="peer w-full bg-transparent border-b border-white/10 focus:border-[#c8a97e] text-[#ffffff] text-sm py-3 outline-none transition-colors resize-none placeholder-transparent"
                  placeholder="Message"
                />
                <label
                  htmlFor="message"
          ...
          <div className="space-y-10">
            <div className="space-y-2">
              ...
              <a
                ...
                className="text-[#e0e0e0] text-sm hover:text-[#c8a97e] transition-colors"
              >
            ...
            <div className="space-y-2">
              ...
              <p className="text-[#e0e0e0] text-sm">Albany, California, USA</p>
            </div>
              ...
              <div className="flex flex-col gap-2">
                {socials.map((s) => (
                  <a
                    ...
                    className="text-[#e0e0e0]/60 text-sm hover:text-[#c8a97e] transition-colors"
                  >
                    {s.label} →
                  </a>
                ))}
